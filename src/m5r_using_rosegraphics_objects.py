...
#            The default height is 300 units.
#
...
#            It is necessary when you wish to move from one RoseWindow to the next. It will close the first example of
#            RoseWindow and move on to the next one.
#
